...
struct iqs5xx_reg_config iqs5xx_reg_config_default(void);
...
#define AbsoluteY_adr			0x0018	//(READ) 2 BYTES	//ADD 0x0007 FOR FINGER 2; 0x000E FOR FINGER 3; 0x0015 FOR
